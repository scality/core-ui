...
`,Checkbox=(0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(({disabled,checked,label,labelHelpTooltip,value,onChange,...rest},ref)=>{const hasLabel=!!label,hasHelpIcon=hasLabel&&!!labelHelpTooltip,labelTextId=(0,react__WEBPACK_IMPORTED_MODULE_1__.useId)(),callerNamesIt=void 0!==rest["aria-label"]||void 0!==rest["aria-labelledby"];return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(StyledCheckbox,{$disabled:disabled,className:"sc-checkbox",children:(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(CheckboxRow,{children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(BoxSlot,{$hasLabel:hasLabel,children:(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(CheckboxInput,{type:"checkbox",checked,disabled,value,onChange,ref,"aria-labelledby":hasHelpIcon&&!callerNamesIt?labelTextId:void 0,...rest})}),hasLabel&&(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(LabelBlock,{children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(LabelText,{id:labelTextId,compact:!0,$reserveHelpIcon:hasHelpIcon,children:label}),hasHelpIcon&&(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_iconhelper_IconHelper__WEBPACK_IMPORTED_MODULE_4__.$m,{tooltipMessage:labelHelpTooltip})]})]})})}),StyledCheckbox=styled_components__WEBPACK_IMPORTED_MODULE_2__.Ay.label`
  ...
  [type='checkbox']::before {
    ...
    box-shadow: inset 0 0 0 ${_spacing__WEBPACK_IMPORTED_MODULE_3__.YK.r1}
...
//# sourceMappingURL=guideline-selection-controls-overview-stories.1749ecc3.iframe.bundle.js.map