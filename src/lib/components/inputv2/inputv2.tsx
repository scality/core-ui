...
export type InputProps = {
  ...
  /**
   * When true, the input keeps its `size` as a preferred width but caps at
   * `100%` of its container and shrinks when there isn't room (instead of
   * overflowing). Automatically enabled for inputs inside a responsive
   * `FormSection`. Off by default.
   */
  fluid?: boolean;
