...
Avoid using an icon alone.

If icon + label, then put the icon on the left side. Seeing the icon first help users to scan the page more easily, except for few cases such as navigation (right arrow).
