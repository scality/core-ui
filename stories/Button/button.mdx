...
| Do                                                      | Don't              |
| ------------------------------------------------------- | ------------------ |
| Check for consistent use across the UI                  | Use icons only     |
| Reserve enough space for translation to other languages | Use punctuation    |
| Avoid excessive use of exclamation points (!)           | Write “Click here” |
