...
`,BottomBar=styled_components__WEBPACK_IMPORTED_MODULE_1__.Ay.hr`
  ...
  ${props=>props.$completed?styled_components__WEBPACK_IMPORTED_MODULE_1__.AH`
      ...
      `};
`;function Step(props){const{title,content,active,completed,isLast,index=0,error,inProgress}=props,circleContent=completed?(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_icon_Icon_component__WEBPACK_IMPORTED_MODULE_5__.In,{name:"Check"}):index+1;return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(StepContainer,{children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel,{children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Circle,{$active:active,$error:error,$completed:completed,children:active&&inProgress?(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_loader_Loader_component__WEBPACK_IMPORTED_MODULE_6__.a,{size:"base"}):(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("span",{children:circleContent})}),!isLast&&(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(BottomBar,{$completed:completed})]}),(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel,{children:[(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div",{style:{height:"30px",display:"flex",alignItems:"center"},children:(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(StepHeader,{$active:active,children:title})}),active&&(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(StepContent,{children:content})]})]})}function Steppers({steps,activeStep,...rest}){return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(SteppersContainer,{...rest,children:steps.map(({title,content,...stepRest},index)=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Step,{title,content,active:index===activeStep,completed:index<activeStep,isLast:index===steps.length-1,index,...stepRest},index))})}try{Steppers.displayName="Steppers",Steppers.__docgenInfo={description:"",displayName:"Steppers",props:{steps:{defaultValue:null,description:"",name:"steps",required:!0,type:{name:"StepProps[]"}},activeStep:{defaultValue:null,description:"",name:"activeStep",required:!0,type:{name:"number"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/lib/components/steppers/Steppers.component.tsx#Steppers"]={docgenInfo:Steppers.__docgenInfo,name:"Steppers",path:"src/lib/components/steppers/Steppers.component.tsx#Steppers"})}catch(__react_docgen_typescript_loader_error){}}}]);
//# sourceMappingURL=stepper-stories.5c0cb192.iframe.bundle.js.map