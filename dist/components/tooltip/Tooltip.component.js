...
var TooltipOverLayContainer = _styledComponents["default"].div(_templateObject2(), function (props) {
  return props && props.overlaystyle && props.overlaystyle.backgroundColor || (0, _utils.getTheme)(props).backgroundContrast2;
}, function (props) {
  return props && props.overlaystyle && props.overlaystyle.color || (0, _utils.getTheme)(props).text;
