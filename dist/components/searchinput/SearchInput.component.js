...
var IconButton = _styledComponents["default"].button(_templateObject2(), defaultTheme.fontSize.base, (0, _utils.getThemePropSelector)("primary"), function (props) {
  return !props.disabled && (0, _styledComponents.css)(_templateObject3(), (0, _polished.lighten)(0.1, (0, _utils.getTheme)(props).primary));
});
