...
var Circle = _styledComponents["default"].div(_templateObject4(), function (props) {
  ...
  if (props.error) {
    ...
    return (0, _styledComponents.css)(_templateObject6(), primary, defaultTheme.white, defaultTheme.white);
...
var StepHeader = _styledComponents["default"].span(_templateObject9(), (0, _utils.getThemePropSelector)("text"));
