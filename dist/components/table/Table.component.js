...
var TableContainer = _styledComponents["default"].div(_templateObject(), (0, _utils.getThemePropSelector)("text"), defaultTheme.fontSize.large, (0, _utils.getThemePropSelector)("backgroundContrast1"), (0, _utils.getThemePropSelector)("border"), (0, _utils.getThemePropSelector)("primary"), defaultTheme.fontSize.large, defaultTheme.fontWeight.semibold, defaultTheme.padding.small, (0, _utils.getThemePropSelector)("text"), (0, _utils.getThemePropSelector)("backgroundContrast1"), (0, _utils.getThemePropSelector)("border"), (0, _utils.getThemePropSelector)("backgroundContrast2"), defaultTheme.padding.small);

var CellContainer = _styledComponents["default"].div(_templateObject2(), (0, _utils.getThemePropSelector)("text"), defaultTheme.padding.smaller, defaultTheme.padding.small, function (props) {
