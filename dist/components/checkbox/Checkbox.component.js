...
var StyledCheckboxLabel = _styledComponents["default"].span(_templateObject(), defaultTheme.fontSize.large, defaultTheme.padding.base, (0, _utils.getThemePropSelector)("text"));
...
var StyledCheckbox = _styledComponents["default"].label(_templateObject2(), function (props) {
  ...
  var _getTheme = (0, _utils.getTheme)(props),
      ...
      backgroundContrast1 = _getTheme.backgroundContrast1;

  var iconCheckedColor = props.checked || props.disabled ? primary : "transparent";
  var checkBoxColor = props.checked || props.disabled ? primary : defaultTheme.grayLight;
  return (0, _styledComponents.css)(_templateObject5(), checkBoxColor, backgroundContrast1, iconCheckedColor, primary);
});