...
var CollapsiblePanelContainer = _styledComponents["default"].div(_templateObject4(), function (props) {
  return (0, _utils.mergeTheme)(props.theme, defaultTheme).backgroundContrast2;
}, function (props) {
  return (0, _utils.mergeTheme)(props.theme, defaultTheme).text;
});
...
var ExpandedContainer = _styledComponents["default"].div(_templateObject6(), defaultTheme.padding.base, function (props) {
  ...
  return (0, _utils.mergeTheme)(props.theme, defaultTheme).backgroundContrast1;
});
