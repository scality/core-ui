...
var InputContainer = _styledComponents["default"].div(_templateObject(), defaultTheme.padding.smaller, function (props) {
  ...
  return (0, _styledComponents.css)(_templateObject2(), backgroundContrast1, text, props.error ? danger : text);
}, defaultTheme.padding.small, defaultTheme.fontSize.base, (0, _utils.getThemePropSelector)("primary"), function (props) {
  if (props.error) {
...
var LabelStyle = _styledComponents["default"].label(_templateObject4(), defaultTheme.padding.small, defaultTheme.fontSize.base, (0, _utils.getThemePropSelector)("text"));
