...
var ChipsContainer = _styledComponents["default"].div(_templateObject(), defaultTheme.white, defaultTheme.grayLight, function (props) {
  ...
  return props.onClick ? (0, _styledComponents.css)(_templateObject7(), brand[props.variant], defaultTheme.white, defaultTheme.fontSize[props.size], brandLight, brand[props.variant]) : (0, _styledComponents.css)(_templateObject8(), brand[props.variant], defaultTheme.white, defaultTheme.fontSize[props.size]);
});

var ChipsIcon = _styledComponents["default"].span(_templateObject9(), function (props) {
  return (0, _polished.lighten)(0.15, (0, _utils.getTheme)(props)[props.variant]).toString();
});

exports.ChipsIcon = ChipsIcon;

var ChipsText = _styledComponents["default"].span(_templateObject10(), function (props) {
