...
var SidebarContainer = _styledComponents["default"].div(_templateObject(), function (props) {
  ...
  return (0, _styledComponents.css)(_templateObject2(), base, primary, primary);
}, function (props) {
  if (props.expanded) {
...
var SidebarItem = _styledComponents["default"].div(_templateObject5(), defaultTheme.padding.base, defaultTheme.fontSize.large, function (props) {
  var _getTheme2 = (0, _utils.getTheme)(props),
      baseContrast1 = _getTheme2.baseContrast1,
      primary = _getTheme2.primary;

  return props.active ? (0, _styledComponents.css)(_templateObject6(), baseContrast1, primary) : (0, _styledComponents.css)(_templateObject7(), baseContrast1, primary, baseContrast1, primary);
});

var MenuItemText = _styledComponents["default"].div(_templateObject8(), defaultTheme.padding.large);

var MenuItemSelected = _styledComponents["default"].div(_templateObject9(), (0, _utils.getThemePropSelector)("primary"));

var MenuItemIcon = _styledComponents["default"].div(_templateObject10(), defaultTheme.navbarItemWidth);
