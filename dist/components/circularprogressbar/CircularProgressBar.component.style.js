...
var CircularProgressBarContainer = _styledComponents["default"].div(_templateObject(), (0, _utils.getThemePropSelector)("text"));
...
var ProgressCircle = _styledComponents["default"].circle(_templateObject3(), function (_ref) {
  ...
  return props.color || (0, _utils.getTheme)(props).primary;
}, function (props) {
...
var BackgroundCircle = _styledComponents["default"].circle(_templateObject4(), function (props) {
  return props.backgroundColor || (0, _utils.getTheme)(props).backgroundContrast2;
}, function (props) {
  return props.strokeWidth;
});
