...
var TabItem = _styledComponents["default"].div(_templateObject3(), function (props) {
  return !props.selected && (0, _styledComponents.css)(_templateObject4(), (0, _utils.getTheme)(props).backgroundContrast2);
});
...
var TabItemTitle = _styledComponents["default"].p(_templateObject5(), defaultTheme.fontSize.large, defaultTheme.padding.base, function (props) {
  ...
  return props.selected ? (0, _styledComponents.css)(_templateObject6(), primary, primary, defaultTheme.fontWeight.bold) : (0, _styledComponents.css)(_templateObject7(), text);
});
