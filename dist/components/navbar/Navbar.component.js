...
var NavbarContainer = _styledComponents["default"].div(_templateObject(), defaultTheme.navbarHeight, (0, _styledComponents.css)(_templateObject2(), (0, _utils.getThemePropSelector)("base"), (0, _utils.getThemePropSelector)("primary"), (0, _utils.getThemePropSelector)("primary")));
...
var TabItem = _styledComponents["default"].div(_templateObject5(), defaultTheme.padding.base, function (props) {
  ...
  return (0, _styledComponents.css)(_templateObject6(), primary, primary);
}, function (props) {
  return props.selected && (0, _styledComponents.css)(_templateObject7(), (0, _utils.getTheme)(props).primary);
});

var TabLinkItem = (0, _styledComponents["default"])(TabItem)(_templateObject8(), (0, _utils.getThemePropSelector)("primary"));

var NavbarMenuItem = _styledComponents["default"].div(_templateObject9(), defaultTheme.navbarHeight, defaultTheme.fontSize.base, defaultTheme.navbarHeight, defaultTheme.fontSize.base);
