...
var SelectContainer = _styledComponents["default"].div(_templateObject(), (0, _utils.getThemePropSelector)("backgroundContrast1"), (0, _utils.getThemePropSelector)("text"), (0, _utils.getThemePropSelector)("text"), (0, _utils.getThemePropSelector)("primary"), (0, _utils.getThemePropSelector)("text"), (0, _utils.getThemePropSelector)("primary"), (0, _utils.getThemePropSelector)("danger"), (0, _utils.getThemePropSelector)("text"), (0, _utils.getThemePropSelector)("backgroundContrast2"), (0, _utils.getThemePropSelector)("danger"), (0, _utils.getThemePropSelector)("primary"), (0, _utils.getThemePropSelector)("backgroundContrast2"), (0, _utils.getThemePropSelector)("backgroundContrast1"), (0, _utils.getThemePropSelector)("text"), (0, _utils.getThemePropSelector)("primary"), defaultTheme.zIndex.dropdown, (0, _utils.getThemePropSelector)("backgroundContrast2"), (0, _utils.getThemePropSelector)("backgroundContrast1"), (0, _utils.getThemePropSelector)("primary"), defaultTheme.fontWeight.bold);
