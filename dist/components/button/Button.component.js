...
var ButtonStyled = _styledComponents["default"].button(_templateObject(), defaultTheme.fontWeight.base, function (props) {
  ...
  var brandLighter = (0, _polished.lighten)(0.3, brand[props.variant]).toString();
  var brandLight = (0, _polished.lighten)(0.1, brand[props.variant]).toString();
  return (0, _styledComponents.css)(_templateObject7(), props.outlined ? "\n        border-width: 1px;\n        border-style: solid;\n        border-color: ".concat(brand[props.variant], ";\n        background-color: ").concat(brand.background, ";\n        color: ").concat(brand[props.variant], ";\n\n        &:hover{\n          border-color: ").concat(brand[props.variant], ";\n          background-color: ").concat(brandLight, ";\n          color: ").concat(brand.background, ";\n        }\n\n        &:active {\n          border-color: ").concat(brand[props.variant], ";\n          background-color: ").concat(brandLighter, ";\n          color:  ").concat(brand.background, ";\n        }\n        ") : "\n        background-color: ".concat(brand[props.variant], ";\n        color: ").concat(defaultTheme.white, ";\n\n        &:hover {\n          background-color: ").concat(brandLight, ";\n          color: ").concat(defaultTheme.white, ";\n        }\n\n        &:active {\n          background-color: ").concat(brand[props.variant], ";\n          color: ").concat(defaultTheme.white, ";\n        }\n      "));
}, function (props) {
  ...
  var brandLight = (0, _polished.lighten)(0.1, brand[props.variant]).toString();
  return (0, _styledComponents.css)(_templateObject10(), !props.text && props.icon && props.inverted ? "\n        padding: 0;\n        height: auto;\n        border: none;\n        background-color: transparent;\n        color: ".concat(props.disabled ? brandLight : brand[props.variant], ";\n\n        &:hover{\n          background-color: transparent;\n          color: ").concat(brandLight, ";\n        }\n\n        &:active {\n          background-color: transparent;\n          color: ").concat(brandLighter, ";\n        }\n        ") : null);
});

exports.ButtonStyled = ButtonStyled;

var ButtonIcon = _styledComponents["default"].span(_templateObject11(), function (props) {
  return props.text && (0, _styledComponents.css)(_templateObject12(), defaultTheme.padding.smaller);
});

exports.ButtonIcon = ButtonIcon;

var ButtonText = _styledComponents["default"].span(_templateObject13());

exports.ButtonText = ButtonText;

var ButtonContent = _styledComponents["default"].span(_templateObject14());
