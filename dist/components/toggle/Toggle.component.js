...
var Switch = _styledComponents["default"].label(_templateObject2(), defaultTheme.padding.small, function (props) {
  ...
  return (0, _styledComponents.css)(_templateObject3(), defaultTheme.grayLight, defaultTheme.grayLight, defaultTheme.grayLight, primary, primary, primary);
});

var StyledSwitchLabel = _styledComponents["default"].span(_templateObject4(), defaultTheme.fontSize.large, (0, _utils.getThemePropSelector)("text"));
