...
var BreadcrumbItem = _styledComponents["default"].li(_templateObject2(), defaultTheme.padding.smaller, defaultTheme.padding.base, defaultTheme.fontSize.larger, (0, _polished.ellipsis)("250px"), function (props) {
  var _getTheme = (0, _utils.getTheme)(props),
      primary = _getTheme.primary,
      text = _getTheme.text;

  if (props.active) {
    return (0, _styledComponents.css)(_templateObject3(), defaultTheme.fontWeight.bold, primary, primary, primary);
  }

  return (0, _styledComponents.css)(_templateObject4(), text, text, primary, primary);
});
